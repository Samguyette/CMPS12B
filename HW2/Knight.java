...
public class Knight extends Piece{
	...
	public static boolean isAttacking(int col, int row, String type, Piece piece){
		...
		if((piece.col == col-1 && piece.row == row+2 && colorChartempBoolean != colorCharBoolean) || 
			(piece.col == col+1 && piece.row == row+2 && colorChartempBoolean != colorCharBoolean)){
		...
		if((piece.col == col+2 && piece.row == row-1 && colorChartempBoolean != colorCharBoolean) || 
			(piece.col == col+2 && piece.row == row+1 && colorChartempBoolean != colorCharBoolean)){
